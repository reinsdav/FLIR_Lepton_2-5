...
#define LCD_RST_LOW()                       CLEAR_BIT(GPIOA->BSRR, GPIO_PIN_1)
#define LCD_RST_HIGH()                      WRITE_REG(GPIOA->BSRR, GPIO_PIN_1)

/* Chip Select macro definition */
#define LCD_CS_LOW()                        CLEAR_BIT(GPIOA->BSRR, GPIO_PIN_9)
...
#define LCD_DC_HIGH()                       CLEAR_BIT(GPIOB->BSRR, GPIO_PIN_10)
